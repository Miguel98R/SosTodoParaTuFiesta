                        ...
                        <div class="modal-body">
                            <form action="validarFoto.php" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="text-center  my-2">
                                    <h4>Escoge un servicio para mostrar la imagen:</h4>
                                    <select id="servicio" class="inputDato" name="servicio">
                                    ...
                                    <div class="row my-1">
                                        ...
                                        <div class="col-md-8 ">
                                            <input type="file" name="image" id="image"
                                                class="form-control-file inputDato ">
                                ...
                                <div class="text-center my-5 "> <input class=" text-center my-1 button2  "
                                        style="background-color: transparent; outline: none;border: none;font-size: 20px;text-decoration: none;"
                                        type="submit" name="enviar" value="Subir imagen"></div>
