...
?>
     ...
     $limite = $numeroReg-1;
        ...
        $consult="SELECT * FROM mesascentros";
        $resultado = $conn->query($consult) or die (mysqli_error($conn));
        

        if($numeroReg>=2){

            $consulta = "SELECT * FROM mesascentros ORDER BY id DESC LIMIT $limite";
        }else if($numeroReg<2){
             $consulta = "SELECT * FROM mesascentros ORDER BY id DESC LIMIT 0";
        }
...
?>
    ...
    <a class="carousel-control-prev" href="#carouselExampleControlsmesascentros" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#carouselExampleControlsmesascentros" role="button" data-slide="next">
