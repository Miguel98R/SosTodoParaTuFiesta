...
?>
     ...
     $limite = $numeroReg-1;
        ...
        $consult="SELECT * FROM brincolin";
        $resultado = $conn->query($consult) or die (mysqli_error($conn));
        

        if($numeroReg>=2){

            $consulta = "SELECT * FROM brincolin ORDER BY id DESC LIMIT $limite";
        }else if($numeroReg<2){
             $consulta = "SELECT * FROM brincolin ORDER BY id DESC LIMIT 0";
        }
...
?>
    ...
    <a class="carousel-control-prev" href="#carouselExampleControlsBrincolin" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#carouselExampleControlsBrincolin" role="button" data-slide="next">
