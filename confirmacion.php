...
" >
  ...
  color:white;">Tu encuesta se ha enviado con exito,gracias por tus comentarios</h1>
...
background-image: linear-gradient(90deg, #FEE140 0%, #FA709A 100%);" >
        ...
        <div class="row">
            <div class="col-md-3 col-sm-12 text-center"> <a class="navbar-brand" href="#"><img src="" class="logo rounded-circle img-fluid py-4"  style="width:50%; height:auto"  alt=""/></a></div>
